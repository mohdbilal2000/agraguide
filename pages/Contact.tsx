      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 font-medium">hello@guideindiatours.com</p>
                  </div>
                </div>
              </div>
          ...
          <div className="rounded-[3rem] overflow-hidden h-96 relative shadow-2xl">
            <OptimizedImage src="https://images.unsplash.com/photo-1599661046289-e3189785002a?auto=format&fit=crop&w=1200&q=80" alt="Jaipur Palace" className="h-full w-full" />
            <div className="absolute inset-0 bg-brand-dark/40 flex items-center justify-center text-center p-8">
               <div className="max-w-2xl">
                  <h3 className="text-3xl md:text-4xl font-bold playfair text-white mb-4">Our Heritage Office</h3>
                  <p className="text-white/80 text-lg">Located just minutes from the Taj Mahal, we are in the heart of Agra's heritage district.</p>
                  <p className="text-brand-gold font-bold mt-4 uppercase tracking-[0.2em] text-sm">Agra • Delhi • Jaipur</p>
               </div>
            </div>
          </div>
        </div>
